...
(function(root){
  ...
  /**
  * Probe for exposing and managing the map of servers known to this site.
  ...
  *
  */
  var SiteMap = Monitor.SiteMap = Probe.extend({
    ...
    initialize: function(attributes, options){
      ...
      t.updateSequence = 0,
      t.buildSiteMap();
      router.on('connection:add connection:remove', t.buildSiteMap, t);
    },
    ...
    */
    ...
    release: function() {
      var t = this,
          router = Monitor.getRouter();
      router.off('connection:add connection:remove', t.buildSiteMap, t);
    }
