  ...
  */
  var PageView = UI.PageView = Backbone.View.extend({
    ...
    render: function() {
      ...
      tourJSON='{ "id": "dunes", "title": "Sandbox Tour - The Dunes", "description": "Tour of the most spectacular sand in the land", "autoNextSec": 5, "pages": [ { "url": "/sandbox", "title": "Sandbox page 1"}, { "url": "/abc", "title": "ABC Page"}, { "url": "/recent2", "title": "Recent Page 2"}, { "url": "/app", "title": "App Overview"}]}'
      if (tourJSON) {
        try {
    ...
    centerPage: function(e) {
      ...
      t.canvas.css({marginLeft: sidebarWidth + Math.max(0, canvasCenter - componentCenter)});
    },
    ...
    toggleEdit: function() {
      var t = this;
      return t.$el.hasClass('edit-mode') ? t.editPage() : t.unlockPage();
    },
