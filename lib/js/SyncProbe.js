// SyncProbe.js (c) 2012 Loren West and other contributors
...
(function(root){
  ...
  * type uses FileSync, and another class uses a different persistence
  * mechanism.
  *
  ...
  *     syncConfig.defaultProbe = 'SyncFile';
  *     syncConfig.classMap = {
  *       Book: 'MongoDbSync',
  *       Author: 'MongoDbSync'
  *     }
