...
(function(root){
  ...
  */
  MonitorPicker.getSiteMap = function() {
    if (!siteMap) {
      ...
      siteMap.on('connect change', function(){
  ...
  */
  var ServerView = MonitorPicker.ServerView = Backbone.View.extend({
    ...
    initialize: function(){
      var t = this;
      t.siteMap = MonitorPicker.getSiteMap();
    ...
    render: function() {
      ...
      if (t.siteMap.isConnected()) {
        t.fillDropdown();
      } else {
        t.siteMap.on('connect', t.fillDropdown, t);
    ...
    fillDropdown: function() {
      ...
      t.siteMap.off('connect', t.fillDropdown, t);
