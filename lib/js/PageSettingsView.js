// PageSettingsView.js (c) 2012 Loren West and other contributors
    ...
    initialize: function(options) {
      ...
      if (!settingsTemplate) {
        settingsTemplate = new Template({
          text: $('#nm-template-PageSettings').html()
        });
      }
    },
  ...
  */
  var PageCopyView = UI.PageCopyView = Backbone.View.extend({
    ...
    initialize: function(options) {
      var t = this;
      if (!copyTemplate) {
        copyTemplate = new Template({
          text: $('#nm-template-PageCopy').html()
        });
      }
    },
